...
However, a crucial but relatively unknown property of hash code, which can be paraphrased as "hashing a hash code with a random string produces another hash".
