...
<button type="button" onclick="f(C_LIKE);">Like (I2P)</button> <button type="button" onclick="f(C_LIKE);">Like (NGROK)</button> button> <button type="button" onclick="f(C_LIKE);">Like (GitHub)</button> 
